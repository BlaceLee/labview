...
extern void IPI_PassorFail_static_AddVIGlobalConstants(void);
VoidFn globConstInitTable[] = {
	Filler,

	IPI_PassorFail_static_AddVIGlobalConstants,
};
...
extern void IPI_PassorFail_static_CleanupLSRs(void);
VoidFn lsrCleanupTable[] = {
	Filler,

	IPI_PassorFail_static_CleanupLSRs,
};
#else
...
const uInt8 nArrTypeData[] = {
	...
	/* Cluster */
	ClusterDataType, 	0, 	0, 	0, 	3, 	0, 	0, 	0, 	4, 	0, 	0, 	0, 		StringDataType, 	0, 	0, 	0, 		StringDataType, 	0, 	0, 	0, 		StringDataType, 	0, 	0, 	0, 
	0
};
...
const uInt32 nArrTypeDataOffsets[] = {
	0, 	24, 	36, 	48, 	60, 	72, 	104, 	116, 	128, 	148, 	180, 	0
};
const uInt32 nArrTypeDataSize = 11;
#else
