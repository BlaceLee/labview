...
struct _IMAQ_Convert_ROI_to_Annulus_heap { 
	cl_170000 c________________;
	cl_170000 c_Coordinates_1;
	cl_C0000 c______________;
	cl_00000 c_error_in__no_error__3;
	float64 n_y;
	float64 n____x_y_4;
	float64 n____x_y_5;
	cl_140000 c_ROI_Descriptor_1;
	...
	cl_100000* c__________CT_3;
	cl_100000* c__________CT_5;
	cl_100000* c__________CT_2;
	VoidHand Args1AE_1;  
...
_DATA_SECTION  cl_100000 IMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42_init_ = 
...
_DATA_SECTION  cl_140000 IMAQ_Convert_ROI_to_Annulus_in_1_ROI_Descriptor_C6_init_ = 
...
_DATA_SECTION static  cl_100000 g_cluster_6 = 
{1, 1, 0, 0, 0, 0, 0.0000000000000000000E+0, 0.0000000000000000000E+0};

_DATA_SECTION static  cl_170000 g_cluster_7 = 
{0, 0, 0, 0, 0, 0};
...
cl_140000 IMAQ_Convert_ROI_to_Annulus_in_1_ROI_Descriptor_C6;
static DataType dtIMAQ_Convert_ROI_to_Annulus_in_1_ROI_Descriptor_C6 = 0x140000 | ClusterDataType;
				...
				DataType dtIMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42, cl_100000**  IMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42	)
{
	...
	*IMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42 = &IMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42_init_;
	PDAClusterIncRefCnt(IMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42, 0x100000 | BigClusterDataType, 1);
...
/* Unbundle */
		...
		{ /* Select */
			...
			if ( heap->b__________status_CS ) {
				{
					{
						MemMove(&(IMAQ_Convert_ROI_to_Annulus_GlobalConstantsHeapPtr->i1F1),&g_cluster_7,GetClusterSize( 0x170000 | ClusterDataType ));
						PDAClusterIncRefCnt(&g_cluster_7,0x170000 | ClusterDataType,1);
					}
					heap->c_Coordinates_1 = IMAQ_Convert_ROI_to_Annulus_GlobalConstantsHeapPtr->i1F1;
					heap->c__________CT_2 = NULL;
					PDAClusterSet( &heap->c_Coordinates_1, 0x170000 | ClusterDataType, &heap->c__________CT_2, 0x100000 | BigClusterDataType);
	}
			} /* end case */
			/* begin case */
			else {
				...
				/*********************************************************************************/
				{
					heap->l_Index = 0;
					heap->dw_Type = 7;
					MemMove(&heap->c_ROI_Descriptor_1, &IMAQ_Convert_ROI_to_Annulus_in_1_ROI_Descriptor_C6, sizeof(cl_140000));
					PDAClusterIncRefCnt(&IMAQ_Convert_ROI_to_Annulus_in_1_ROI_Descriptor_C6,0x140000 | ClusterDataType,1);
/* Unbundle by name */
					{
						cl_140000* cl_004 = (cl_140000*)&heap->c_ROI_Descriptor_1;
						PDAArrIncRefCnt(cl_004->el_1, (uInt16)1); /*  */
						heap->a________________Contours = cl_004->el_1;
	/* Free Cluster heap->c_ROI_Descriptor_1*/
						{
							cl_140000* cl_005 = (cl_140000*)&heap->c_ROI_Descriptor_1;
						...
						if ( heap->b________x___y__CS ) {
							{
								...
								/* 数组至簇转换 */
								/**/
								if (!PDAArrToClust(heap->a__________Coordinates, 0xB0000 | ArrayDataType, (int32)6, &(heap->c________________), 0x170000 | ClusterDataType)) {
									CGenErr();
								}
/* Unbundle */
								{
									cl_170000* cl_008 = (cl_170000*)&heap->c________________;
								...
								/* 除 */
								/**/
								PDAFltBinop( &heap->l__________Coordinates_5_, int32DataType, &heap->n_y, doubleDataType, opDiv, &heap->n____x_y_4, doubleDataType);
								/**/
								/* 除 */
								/**/
								PDAFltBinop( &heap->l__________Coordinates_4_, int32DataType, &heap->n_y, doubleDataType, opDiv, &heap->n____x_y_5, doubleDataType);
/* Bundle */
								{
									cl_100000* cl_009 = NULL;
									heap->c__________CT_2 = PDAClusterNewEmpty(0x100000 | BigClusterDataType);
									cl_009 = (cl_100000*)heap->c__________CT_2;
									...
									cl_009->el_4 = heap->n____x_y_5;
									cl_009->el_5 = heap->n____x_y_4;
								}
							}
						} /* end case */
						/* begin case */
	...
	if ((heap->a__________Coordinates) && ((heap->a__________Coordinates)->refcnt > 0)) {
								...
								if ( !IMAQ_Convert_ROI_to_Annulus_GlobalConstantsHeapPtr->i150 ) {
									{
										IMAQ_Convert_ROI_to_Annulus_GlobalConstantsHeapPtr->i150 = (cl_100000*)&g_cluster_6;
									}
								}
								PDAClusterIncRefCnt(&IMAQ_Convert_ROI_to_Annulus_GlobalConstantsHeapPtr->i150,0x100000 | BigClusterDataType,1);
		...
		if (IMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42) {
			...
			PDAClusterFree( IMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42, 0x100000 | BigClusterDataType );
			PDAClusterCopyOnModify(&heap->c__________CT_2, 0x100000 | BigClusterDataType, IMAQ_Convert_ROI_to_Annulus_out_1_Annulus_42);
		}
		else {
		}
		...
		PDAClusterFree( &IMAQ_Convert_ROI_to_Annulus_in_1_ROI_Descriptor_C6, 0x140000 | ClusterDataType);
