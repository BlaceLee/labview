...
_DATA_SECTION  cl_120000 IMAQ_Overlay_Text_in_6_Origin_1C_init_ = 
{0, 0};
...
cl_120000 IMAQ_Overlay_Text_in_6_Origin_1C;
static DataType dtIMAQ_Overlay_Text_in_6_Origin_1C = 0x120000 | ClusterDataType;
				...
				DataType dtIMAQ_Overlay_Text_out_1_Image_Out_A8, CCGRCRefnumHandle*  IMAQ_Overlay_Text_out_1_Image_Out_A8	)
{
	...
	*IMAQ_Overlay_Text_out_0_error_out_44 = IMAQ_Overlay_Text_out_0_error_out_44_init_;
	...
	IMAQ_Overlay_Text_InitVIConstantList();
	{
		...
		MemMove(&heap->c_Origin_1, &IMAQ_Overlay_Text_in_6_Origin_1C, sizeof(cl_120000));
		PDAClusterIncRefCnt(&IMAQ_Overlay_Text_in_6_Origin_1C,0x120000 | ClusterDataType,1);
...
/* Call Library Node */
		{
			...
			arg3 = GetClusterPtr( &heap->c_Origin_1, 0x120000 | ClusterDataType);
			if (gLastError) {
				CGenErr();
			}
	...
	if (heap->s_String_2 && (((PDAStrPtr)heap->s_String_2)->refcnt > 0)) {
			...
			PDAClusterFreeDataPtr(arg3, 0x120000 | ClusterDataType);
	...
	CCGRCRefnumFree(IMAQ_Overlay_Text_in_7_Image_A6);
		...
		PDAClusterFree( &IMAQ_Overlay_Text_in_6_Origin_1C, 0x120000 | ClusterDataType);
