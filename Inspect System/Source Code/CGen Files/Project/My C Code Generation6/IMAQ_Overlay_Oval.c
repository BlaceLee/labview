...
struct _IMAQ_Overlay_Oval_heap { 
	cl_110000 c_Bounding_Rectangle;
...
_DATA_SECTION  cl_110000 IMAQ_Overlay_Oval_in_4_Bounding_Rectangle_F_init_ = 
{0, 0, 0, 0};
...
cl_110000 IMAQ_Overlay_Oval_in_4_Bounding_Rectangle_F;
static DataType dtIMAQ_Overlay_Oval_in_4_Bounding_Rectangle_F = 0x110000 | ClusterDataType;
				...
				DataType dtIMAQ_Overlay_Oval_out_1_Image_Out_62, CCGRCRefnumHandle*  IMAQ_Overlay_Oval_out_1_Image_Out_62	)
{
	...
	*IMAQ_Overlay_Oval_out_0_error_out_41 = IMAQ_Overlay_Oval_out_0_error_out_41_init_;
	...
	{
		heap->dw_Color_2 = IMAQ_Overlay_Oval_in_0_Color_9;
		{
		...
		MemMove(&heap->c_Bounding_Rectangle, &IMAQ_Overlay_Oval_in_4_Bounding_Rectangle_F, sizeof(cl_110000));
		PDAClusterIncRefCnt(&IMAQ_Overlay_Oval_in_4_Bounding_Rectangle_F,0x110000 | ClusterDataType,1);
		heap->dw_Drawing_Mode__Frame__2 =IMAQ_Overlay_Oval_in_3_Drawing_Mode__Frame__1;
...
/* Call Library Node */
		{
			...
			arg2 = GetClusterPtr( &heap->c_Bounding_Rectangle, 0x110000 | ClusterDataType);
			if (gLastError) {
				CGenErr();
			}
			arg3 = heap->dw_Drawing_Mode__Frame__2;
			...
			PDAClusterFreeDataPtr(arg2, 0x110000 | ClusterDataType);
	...
	CCGRCRefnumFree(IMAQ_Overlay_Oval_in_5_Image_64);
		...
		PDAClusterFree( &IMAQ_Overlay_Oval_in_4_Bounding_Rectangle_F, 0x110000 | ClusterDataType);
