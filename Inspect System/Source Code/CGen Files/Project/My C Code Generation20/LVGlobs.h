...
extern void IPI_DrawRent_AddVIGlobalConstants(void);
VoidFn globConstInitTable[] = {
	Filler,

	IPI_DrawRent_AddVIGlobalConstants,
};
...
extern void IPI_DrawRent_CleanupLSRs(void);
VoidFn lsrCleanupTable[] = {
	Filler,

	IPI_DrawRent_CleanupLSRs,
};
#else
...
const uInt8 nArrTypeData[] = {
	...
	/* Cluster */
	ClusterDataType, 	0, 	0, 	0, 	14, 	0, 	0, 	0, 	4, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 		BooleanDataType, 	0, 	0, 	0, 
	/* Cluster */
	ClusterDataType, 	0, 	0, 	0, 	1, 	0, 	0, 	0, 	5, 	0, 	0, 	0, 		StringDataType, 	0, 	0, 	0, 
	0
};
...
const uInt32 nArrTypeDataOffsets[] = {
	0, 	24, 	36, 	48, 	60, 	72, 	104, 	116, 	128, 	148, 	180, 	248, 	0
};
