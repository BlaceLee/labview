...
extern void IPI_Value_Test_AddVIGlobalConstants(void);
VoidFn globConstInitTable[] = {
	Filler,

	IPI_Value_Test_AddVIGlobalConstants,
};
...
extern void IPI_Value_Test_CleanupLSRs(void);
VoidFn lsrCleanupTable[] = {
	Filler,

	IPI_Value_Test_CleanupLSRs,
};
#else
