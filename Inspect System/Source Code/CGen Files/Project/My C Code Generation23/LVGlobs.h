...
extern void IPI_OptionChangeString_AddVIGlobalConstants(void);
VoidFn globConstInitTable[] = {
	Filler,

	IPI_OptionChangeString_AddVIGlobalConstants,
};
...
extern void IPI_OptionChangeString_CleanupLSRs(void);
VoidFn lsrCleanupTable[] = {
	Filler,

	IPI_OptionChangeString_CleanupLSRs,
};
#else
...
const uInt8 nArrTypeData[] = {
	...
	/* Cluster */
	BigClusterDataType, 	0, 	0, 	0, 	2, 	0, 	0, 	0, 	6, 	0, 	0, 	0, 		uInt32DataType, 	0, 	0, 	0, 		ClusterDataType, 	0, 	12, 	0, 
	0
};
...
const uInt32 nArrTypeDataOffsets[] = {
	0, 	24, 	36, 	48, 	60, 	72, 	104, 	116, 	128, 	148, 	180, 	240, 	264, 	300, 	356, 	0
};
