...
struct _IMAQ_Overlay_Text_heap { 
	...
	cl_130000 c_Origin_1;
	uInt32 dw_Text_Color__black__2;
	uInt32 dw_BG_Color__Transparent__1;
	uInt32 dw_Color_to_RGB_vi____________1;
	uInt32 dw_Color_to_RGB_vi___________;
	cl_F0000* c_Font__Size___Style_1;
	VoidHand s_String_2;
	VoidHand s_Group;
...
_DATA_SECTION  cl_130000 IMAQ_Overlay_Text_in_6_Origin_1C_init_ = 
{0, 0};
...
cl_130000 IMAQ_Overlay_Text_in_6_Origin_1C;
static DataType dtIMAQ_Overlay_Text_in_6_Origin_1C = 0x130000 | ClusterDataType;
				...
				DataType dtIMAQ_Overlay_Text_out_1_Image_Out_A8, CCGRCRefnumHandle*  IMAQ_Overlay_Text_out_1_Image_Out_A8	)
{
	...
	*IMAQ_Overlay_Text_out_0_error_out_44 = IMAQ_Overlay_Text_out_0_error_out_44_init_;
	...
	{
		heap->dw_BG_Color__Transparent__1 = IMAQ_Overlay_Text_in_0_BG_Color__Transparent__10;
		{
			...
			if ((Color_to_RGB_Run( 	uInt32DataType, heap->dw_BG_Color__Transparent__1,
		...
		heap->dw_Text_Color__black__2 = IMAQ_Overlay_Text_in_2_Text_Color__black__16;
		{
			extern uInt32 Color_to_RGB_out_0_Resolved_Color_9_init_;
			uInt32 Color_to_RGB_out_0_Resolved_Color_9 = Color_to_RGB_out_0_Resolved_Color_9_init_;
			extern uInt8 Color_to_RGB_out_1_R_1C_init_;
			...
			if ((Color_to_RGB_Run( 	uInt32DataType, heap->dw_Text_Color__black__2,
		...
		heap->s_String_2 =IMAQ_Overlay_Text_in_5_String_9;
		PDAStrIncRefCnt(IMAQ_Overlay_Text_in_5_String_9,1);
		MemMove(&heap->c_Origin_1, &IMAQ_Overlay_Text_in_6_Origin_1C, sizeof(cl_130000));
		PDAClusterIncRefCnt(&IMAQ_Overlay_Text_in_6_Origin_1C,0x130000 | ClusterDataType,1);
		heap->c_Font__Size___Style_1 = (cl_F0000*)IMAQ_Overlay_Text_in_3_Font__Size___Style_61;
		PDAClusterIncRefCnt(&IMAQ_Overlay_Text_in_3_Font__Size___Style_61,0xF0000 | BigClusterDataType,1);
		MemMove(&heap->c_error_in__no_error__1, &IMAQ_Overlay_Text_in_4_error_in__no_error__2E, sizeof(cl_00000));
...
/* Call Library Node */
		{
			...
			arg2 = GetStringVal(heap->s_String_2);
			if (!arg2) {
				CGenErr();
			}
			arg3 = GetClusterPtr( &heap->c_Origin_1, 0x130000 | ClusterDataType);
			if (gLastError) {
				CGenErr();
			}
			arg4 = heap->dw_Color_to_RGB_vi____________1;
			arg5 = heap->dw_Color_to_RGB_vi___________;
			arg6 = GetClusterPtr( &heap->c_Font__Size___Style_1, 0xF0000 | BigClusterDataType);
			if (gLastError) {
				CGenErr();
			}
	...
	if (heap->s_String_2 && (((PDAStrPtr)heap->s_String_2)->refcnt > 0)) {
				if ((--((PDAStrPtr)heap->s_String_2)->refcnt == 0) && (!((PDAStrPtr)heap->s_String_2)->staticStr)) {
					MemHandleFree( heap->s_String_2 );
					heap->s_String_2=NULL;
				}
			}
			PDAClusterFreeDataPtr(arg3, 0x130000 | ClusterDataType);
	PDAClusterFreeDataPtr(arg6, 0xF0000 | BigClusterDataType);
	/* Free Cluster heap->c_Font__Size___Style_1*/
			PDAClusterFree( &heap->c_Font__Size___Style_1, 0xF0000 | BigClusterDataType );
			PDAClusterFreeDataPtr(arg7, 0x0 | ClusterDataType);
	/* Free Cluster heap->c_error_in__no_error__1*/
			{
				cl_00000* cl_002 = (cl_00000*)&heap->c_error_in__no_error__1;
	...
	CCGRCRefnumFree(IMAQ_Overlay_Text_in_7_Image_A6);
		...
		PDAClusterFree( &IMAQ_Overlay_Text_in_6_Origin_1C, 0x130000 | ClusterDataType);
