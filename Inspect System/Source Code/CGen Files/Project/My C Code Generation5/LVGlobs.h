...
extern void CS_Set_the_inner_circle_parameters_AddVIGlobalConstants(void);
VoidFn globConstInitTable[] = {
	Filler,

	CS_Set_the_inner_circle_parameters_AddVIGlobalConstants,
};
...
extern void CS_Set_the_inner_circle_parameters_CleanupLSRs(void);
VoidFn lsrCleanupTable[] = {
	Filler,

	CS_Set_the_inner_circle_parameters_CleanupLSRs,
};
#else
