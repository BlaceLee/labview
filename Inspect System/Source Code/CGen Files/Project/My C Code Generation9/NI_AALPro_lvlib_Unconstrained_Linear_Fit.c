				...
				DataType dtNI_AALPro_lvlib_Unconstrained_Linear_Fit_out_4_error_3E, int32*  NI_AALPro_lvlib_Unconstrained_Linear_Fit_out_4_error_3E	)
{
	...
	*NI_AALPro_lvlib_Unconstrained_Linear_Fit_out_0_Best_Linear_Fit_17 = (PDAArrPtr)(&NI_AALPro_lvlib_Unconstrained_Linear_Fit_out_0_Best_Linear_Fit_17_init_);
	...
	NI_AALPro_lvlib_Unconstrained_Linear_Fit_InitVIConstantList();
	{
					...
					{
						{
							...
							heap->n__________CT_4 = NI_AALPro_lvlib_Linear_Fit__LAR__out_1_slope_56_init_;
							heap->n__________CT_3 = NI_AALPro_lvlib_Linear_Fit__LAR__out_2_intercept_4C_init_;
							heap->n__________CT_2 = NI_AALPro_lvlib_Linear_Fit__LAR__out_3_residue_36_init_;
							...
							doubleDataType, &heap->n__________CT_4,
							doubleDataType, &heap->n__________CT_3,
					...
					{
						{
							...
							heap->n__________CT_4 = NI_AALPro_lvlib_Linear_Fit__Bisquare__out_1_slope_50_init_;
							heap->n__________CT_3 = NI_AALPro_lvlib_Linear_Fit__Bisquare__out_2_intercept_5B_init_;
							heap->n__________CT_2 = NI_AALPro_lvlib_Linear_Fit__Bisquare__out_3_residue_8F_init_;
					...
					{
						{
							...
							heap->n__________CT_4 = NI_AALPro_lvlib_Linear_Fit__LS__out_1_slope_56_init_;
							heap->n__________CT_3 = NI_AALPro_lvlib_Linear_Fit__LS__out_2_intercept_4C_init_;
							heap->n__________CT_2 = NI_AALPro_lvlib_Linear_Fit__LS__out_3_residue_36_init_;
		...
		*NI_AALPro_lvlib_Unconstrained_Linear_Fit_out_1_slope_56 = heap->n__________CT_4;
		*NI_AALPro_lvlib_Unconstrained_Linear_Fit_out_2_intercept_4C = heap->n__________CT_3;
		*NI_AALPro_lvlib_Unconstrained_Linear_Fit_out_4_error_3E = heap->l__________CT;
		*NI_AALPro_lvlib_Unconstrained_Linear_Fit_out_3_residue_36 = heap->n__________CT_2;
