...
struct _IMAQ_Overlay_Line_heap { 
	...
	cl_B0000 c_Start_Point_1;
	cl_B0000 c_End_Point;
	uInt32 dw_Color_1;
...
_DATA_SECTION  cl_B0000 IMAQ_Overlay_Line_in_4_Start_Point_20_init_ = 
{0, 0};

_DATA_SECTION  cl_B0000 IMAQ_Overlay_Line_in_3_End_Point_8_init_ = 
{0, 0};
...
cl_B0000 IMAQ_Overlay_Line_in_4_Start_Point_20;
static DataType dtIMAQ_Overlay_Line_in_4_Start_Point_20 = 0xB0000 | ClusterDataType;
uInt32 IMAQ_Overlay_Line_in_0_Color_1A = RGB(255, 0, 0);
static DataType dtIMAQ_Overlay_Line_in_0_Color_1A = uInt32DataType;
cl_B0000 IMAQ_Overlay_Line_in_3_End_Point_8;
static DataType dtIMAQ_Overlay_Line_in_3_End_Point_8 = 0xB0000 | ClusterDataType;
				...
				DataType dtIMAQ_Overlay_Line_out_1_Image_Out_2, CCGRCRefnumHandle*  IMAQ_Overlay_Line_out_1_Image_Out_2	)
{
	...
	*IMAQ_Overlay_Line_out_0_error_out_48 = IMAQ_Overlay_Line_out_0_error_out_48_init_;
	...
	{
		heap->dw_Color_1 = IMAQ_Overlay_Line_in_0_Color_1A;
		{
		...
		heap->l_Image = (CCGRCRefnumHandle)IMAQ_Overlay_Line_in_5_Image_65;
		CCGRCRefnumIncRefCnt(heap->l_Image, 1);
		MemMove(&heap->c_Start_Point_1, &IMAQ_Overlay_Line_in_4_Start_Point_20, sizeof(cl_B0000));
		PDAClusterIncRefCnt(&IMAQ_Overlay_Line_in_4_Start_Point_20,0xB0000 | ClusterDataType,1);
		MemMove(&heap->c_End_Point, &IMAQ_Overlay_Line_in_3_End_Point_8, sizeof(cl_B0000));
		PDAClusterIncRefCnt(&IMAQ_Overlay_Line_in_3_End_Point_8,0xB0000 | ClusterDataType,1);
		MemMove(&heap->c_error_in__no_error__1, &IMAQ_Overlay_Line_in_2_error_in__no_error__32, sizeof(cl_00000));
		PDAClusterIncRefCnt(&IMAQ_Overlay_Line_in_2_error_in__no_error__32,0x0 | ClusterDataType,1);
		heap->s_Group =IMAQ_Overlay_Line_in_1_Group_112;
...
/* Call Library Node */
		{
			...
			arg2 = GetClusterPtr( &heap->c_Start_Point_1, 0xB0000 | ClusterDataType);
			if (gLastError) {
				CGenErr();
			}
			arg3 = GetClusterPtr( &heap->c_End_Point, 0xB0000 | ClusterDataType);
			if (gLastError) {
				CGenErr();
			}
	...
	PDAClusterFreeDataPtr(arg3, 0xB0000 | ClusterDataType);
	...
	CCGRCRefnumFree(IMAQ_Overlay_Line_in_5_Image_65);
		...
		PDAClusterFree( &IMAQ_Overlay_Line_in_4_Start_Point_20, 0xB0000 | ClusterDataType);
		PDAClusterFree( &IMAQ_Overlay_Line_in_3_End_Point_8, 0xB0000 | ClusterDataType);
