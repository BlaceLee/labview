...
extern void IPI_ROI_Set_AddVIGlobalConstants(void);
VoidFn globConstInitTable[] = {
	Filler,

	IPI_ROI_Set_AddVIGlobalConstants,
};
...
extern void IPI_ROI_Set_CleanupLSRs(void);
VoidFn lsrCleanupTable[] = {
	Filler,

	IPI_ROI_Set_CleanupLSRs,
};
#else
...
const uInt8 nArrTypeData[] = {
	...
	/* Enum */
	Enum32DataType, 	0, 	0, 	0, 	2, 	0, 	0, 	0, 	8, 
	'E', 	'x', 	't', 	'e', 	'r', 	'n', 	'a', 	'l', 	8, 
	'I', 	'n', 	't', 	'e', 	'r', 	'n', 	'a', 	'l', 0, 0, 
	/* Array */
	ArrayDataType, 	0, 	0, 	0, 		int32DataType, 	0, 	0, 	0, 	1, 0, 0, 0, 
	/* Cluster */
	ClusterDataType, 	0, 	0, 	0, 	3, 	0, 	0, 	0, 	4, 	0, 	0, 	0, 		Enum32DataType, 	0, 	10, 	0, 		uInt32DataType, 	0, 	0, 	0, 		ArrayDataType, 	0, 	11, 	0, 
	/* Array */
	ArrayDataType, 	0, 	0, 	0, 		ClusterDataType, 	0, 	12, 	0, 	1, 0, 0, 0, 
	/* Cluster */
	ClusterDataType, 	0, 	0, 	0, 	2, 	0, 	0, 	0, 	5, 	0, 	0, 	0, 		ArrayDataType, 	0, 	11, 	0, 		ArrayDataType, 	0, 	13, 	0, 
	/* Cluster */
	ClusterDataType, 	0, 	0, 	0, 	2, 	0, 	0, 	0, 	6, 	0, 	0, 	0, 		int32DataType, 	0, 	0, 	0, 		int32DataType, 	0, 	0, 	0, 
	0
};
...
const uInt32 nArrTypeDataOffsets[] = {
	0, 	24, 	36, 	48, 	60, 	72, 	104, 	116, 	128, 	148, 	180, 	208, 	220, 	244, 	256, 	276, 	0
};
