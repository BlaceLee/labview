				...
				DataType dtIMAQ_Clear_Overlay_out_1_Image_Out_3B, CCGRCRefnumHandle*  IMAQ_Clear_Overlay_out_1_Image_Out_3B	)
{
	...
	*IMAQ_Clear_Overlay_out_0_error_out_1E = IMAQ_Clear_Overlay_out_0_error_out_1E_init_;
	...
	{
		heap->l_Image_1 = (CCGRCRefnumHandle)IMAQ_Clear_Overlay_in_2_Image_1;
		CCGRCRefnumIncRefCnt(heap->l_Image_1, 1);
		MemMove(&heap->c_error_in__no_error__2, &IMAQ_Clear_Overlay_in_1_error_in__no_error__8, sizeof(cl_00000));
...
/* Call Library Node */
		{
			...
			arg2 = GetClusterPtr( &heap->c_error_in__no_error__2, 0x0 | ClusterDataType);
			if (gLastError) {
				CGenErr();
			}
